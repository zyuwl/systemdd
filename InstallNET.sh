...
function selectMirror() {
    ...
    MirrorBackup=(["debian0"]="" ["debian1"]="https://mirrors.tuna.tsinghua.edu.cn/debian" ["debian2"]="http://mirrors.163.com/debian-archive" ["ubuntu0"]="" ["ubuntu1"]="http://mirrors.aliyun.com/ubuntu" ["centos0"]="" ["centos1"]="http://mirrors.aliyun.com/centos" ["centos2"]="http://mirrors.aliyun.com/centos-vault")
